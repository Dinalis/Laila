                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-type="edit" data-id="<?= $b['idrole']; ?>" class="badge badge-primary" data-original-title="Edit">
                                                            Edit
                                                        </button>
                                                        <?php if ($b['idrole'] != $this->session->userdata('idrole')) : ?>
                                                            <button type="button" data-type="hapus" data-id="<?= $b['idrole']; ?>" class="badge badge-danger" data-original-title="Hapus">
                                                                Hapus
                                                            </button>
                                                        <?php endif; ?>
                                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('master/role') ?>" id="modal_post">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Role</label>
                                <input id="role" name="role" type="text" class="form-control" placeholder="isi role" value="" required>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('[data-type=edit]').click(function() {
        ...
        xhrfGetData("<?= site_url('master/getrole/') ?>" + id, function(data) {
            ...
            modal.find('#key').val(data.idrole);
            Swal.close();
            modal.modal();
        });
    });
    ...
    $('[data-type=delete]').click(function() {
        location.href = '<?= site_url('master/hapusRole/') ?>' + $(this).attr('data-id');
    });
</script>