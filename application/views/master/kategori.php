                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-type="edit" data-id="<?= $b['idkategori']; ?>" class="badge badge-primary">
                                                            Edit
                                                        </button>
                                                        <button type="button" data-type="hapus" data-id="<?= $b['idkategori']; ?>" class="badge badge-danger">
                                                            Hapus
                                                        </button>
                                                    </div>
                                                </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('master/kategori') ?>" id="modal_post">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                <label>Kategori</label>
                                <input id="kategori" name="kategori" type="text" class="form-control" placeholder="isi kategori" value="" required>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('[data-type=delete]').click(function() {
        location.href = '<?= site_url('master/hapusKategori/') ?>' + $(this).attr('data-id');
    });
</script>