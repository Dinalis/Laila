                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($pelanggan as $b) : ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?= $b['jeniskelamin'] == 1 ? 'Perempuan' : 'Laki-laki'; ?></td>
                                                <td><?= $b['telp']; ?></td>
                                                <td><?= $b['alamat']; ?></td>
                                                <td><?= $b['infotambahan']; ?></td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <button type="button" data-type="edit" data-id="<?= $b['idpelanggan']; ?>" class="badge badge-primary">
                                                            Edit
                                                        </button>
                                                        <button type="button" data-type="hapus" data-id="<?= $b['idpelanggan']; ?>" class="badge badge-danger">
                                                            Hapus
                                                        </button>
                                                    </div>
                                                </td>
